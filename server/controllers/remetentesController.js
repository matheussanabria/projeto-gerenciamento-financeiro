...
exports.createRemetente = async (req, res) => {
    ...
    try {
        const result = await db.query(
            'INSERT INTO remetentes (remetente_nome, remetente_cpf_cnpj, remetente_endereco, remetente_telefone) VALUES ($1, $2, $3, $4) RETURNING *',
            [remetente_nome, remetente_cpf_cnpj, remetente_endereco, remetente_telefone]
        );
